...
void DCA_dist(){
    ...
    TFile* f6 = new TFile("normalizing_two_TGraphs_ccbar_stat.root","READ");
    ...
    TFile* f7 = new TFile("normalizing_two_TGraphs_bbbar_stat.root","READ");
    ...
    TLatex *   tex4 = new TLatex(1000,2e-7, "p_{T}^{pair} < 5 GeV/c");
    ...
    TLatex *   tex5 = new TLatex(1020,4e-7, "p_{T}^{trig, e} > 1.5 GeV/c");
    ...
    TLatex *   tex6 = new TLatex(20,7e-5, "0.87 < m_{ee} << 4.50 GeV/c^{2}");
