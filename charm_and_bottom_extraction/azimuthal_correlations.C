...
void azimuthal_correlations(){
    ...
    TH2D* h2d_delta_phi_pair_mass_ccbar_central_stat = (TH2D*)fccbar_stat->Get("h2d_delta_phi_pair_mass_ccbar_central");
    ...
    TH2D* h2d_delta_phi_pair_mass_ccbar_lower_stat = (TH2D*)fccbar_stat->Get("h2d_delta_phi_pair_mass_ccbar_lower");
    ...
    TH2D* h2d_delta_phi_pair_mass_ccbar_upper_stat = (TH2D*)fccbar_stat->Get("h2d_delta_phi_pair_mass_ccbar_upper");
    ...
    TFile* fbbbar_stat = new TFile("normalizing_two_TGraphs_bbbar_stat.root","READ");

    TH2D* h2d_delta_phi_pair_mass_bbbar_central_stat = (TH2D*)fbbbar_stat->Get("h2d_delta_phi_pair_mass_bbbar_central");
    ...
    TH2D* h2d_delta_phi_pair_mass_bbbar_lower_stat = (TH2D*)fbbbar_stat->Get("h2d_delta_phi_pair_mass_bbbar_lower");
    ...
    TH2D* h2d_delta_phi_pair_mass_bbbar_upper_stat = (TH2D*)fbbbar_stat->Get("h2d_delta_phi_pair_mass_bbbar_upper");
    ...
    TH2D* h2d_delta_phi_pair_mass_ccbar_central_sys = (TH2D*)fccbar_sys->Get("h2d_delta_phi_pair_mass_ccbar_central");
    ...
    h1d_delta_phi_ccbar_lower_sys->Scale(1.0-0.0947);
    ...
    h1d_delta_phi_ccbar_upper_sys->Scale(1.0+0.0947);

    // bbbar files

    TFile* fbbbar_sys = new TFile("normalizing_two_TGraphs_bbbar_sys.root","READ");

    TH2D* h2d_delta_phi_pair_mass_bbbar_central_sys = (TH2D*)fbbbar_sys->Get("h2d_delta_phi_pair_mass_bbbar_central");
    ...
    h1d_delta_phi_bbbar_lower_sys->Scale(1.0-0.1618);
    ...
    h1d_delta_phi_bbbar_upper_sys->Scale(1.0+0.1618);
