...
void pair_pt(){
    ...
    h1d_pair_pt_ccbar->Scale(0.8401);
    h1d_pair_pt_bbbar->Scale(1.45053);
    ...
    h1d_pair_pt_ccbar_lower_stat->Scale(1.0-0.1186);
    ...
    h1d_pair_pt_ccbar_upper_stat->Scale(1.0+0.1186);
    ...
    h1d_pair_pt_bbbar_lower_stat->Scale(1.0-0.2907);
    ...
    h1d_pair_pt_bbbar_upper_stat->Scale(1.0+0.2907);
    ...
    h1d_pair_pt_ccbar_lower_sys->Scale(1.0-0.0947);
    ...
    h1d_pair_pt_ccbar_upper_sys->Scale(1.0+0.0947);
    ...
    h1d_pair_pt_bbbar_lower_sys->Scale(1.0-0.1618);
    ...
    h1d_pair_pt_bbbar_upper_sys->Scale(1.0+0.1618);
