...
void plotting_full_ccbar(){
    ...
    datafile.open("plotting_full_ccbar_corrected.txt",std::ofstream::app);


    TFile* f1 = new TFile("obtaining_ccbar_from_mass_space_corrected.root","READ");
    ...
    TFile* f2 = new TFile("plotting_ccbar_from_DCA_Fits_with_systematics_corrected.root","READ");
